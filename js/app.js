...
const sttaddr = "0x2481febbcf89a2a28bb573cfee4a1cdbde26a4c9";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x2481febbcf89a2a28bb573cfee4a1cdbde26a4c9";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://usdtrade.network/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x2481febbcf89a2a28bb573cfee4a1cdbde26a4c9',
                    'symbol': 'UTRADE',
                    'decimals': '18',
                    'image': 'https://usdtrade.network/img/logo.png',
                },
            },
